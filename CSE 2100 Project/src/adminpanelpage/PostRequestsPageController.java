 ...
 * @author labib
 */
public class PostRequestsPageController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for(int i = NEWS_DATABASE_STACK.size()-1; i >= 0; i--){
            if(NEWS_DATABASE_STACK.get(i).getApproved().equals("1"))
                continue;
            try{
                AnchorPane postRows = FXMLLoader.load(getClass().getResource("/adminpanelpage/postRequestDataRows.fxml"));
