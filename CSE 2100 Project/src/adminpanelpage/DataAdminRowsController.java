 ...
 * @author labib
 */
public class DataAdminRowsController implements Initializable {
        ...
        Thread x = new Thread(new Runnable(){
            ...
            public void run() {
                Platform.runLater(new Runnable(){
                    ...
                    public void run() {
                        try{                                     
                            PageNavigationSystem.pns.upDateCurrentPage("/adminpanelpage/AdminPanelPage2.fxml", "/adminpanelpage/AdminsListPage.fxml");                           
                        }catch(Exception e){}
                    }        
                });
            }         
