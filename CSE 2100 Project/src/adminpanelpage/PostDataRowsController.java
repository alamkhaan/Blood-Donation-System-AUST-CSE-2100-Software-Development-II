...
import static pagenavigation.PageNavigationSystem.pns;
 ...
 * @author labib
 */
public class PostDataRowsController implements Initializable {
        ...
        Thread x = new Thread(new Runnable(){
            ...
            public void run() {
                Platform.runLater(new Runnable(){
                    ...
                    public void run() {
                        try{                            
                            PageNavigationSystem.pns.upDateCurrentPage("/adminpanelpage/AdminPanelPage2.fxml", "/adminpanelpage/PostsPage.fxml");                           
                        }catch(Exception e){}
                    }        
                });
            }         
