 ...
 * @author labib
 */
public class AdminPanelViewProfilePageController implements Initializable {
    ...
    void makeAdmin(ActionEvent event) {
        ...
        PageNavigationSystem.pns.upDatePreviousPage("/adminpanelpage/AdminPanelPage2.fxml", "/adminpanelpage/AdminsListPage.fxml");
