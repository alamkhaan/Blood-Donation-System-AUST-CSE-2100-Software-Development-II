 ...
 * @author labib
 */
public class DonorsListPageController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {         
            ...
            AnchorPane root;           
            for(int i = 0; i < DONOR_DATABASE_LIST.size(); i++){
                User user;
                root = FXMLLoader.load(getClass().getResource("/adminpanelpage/dataRows2.fxml")); 
